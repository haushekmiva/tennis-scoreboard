...
public class FinishedMatchesServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.finishedMatchPersistence = (FinishedMatchPersistence) context.getAttribute(
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (playerName == null) {
            matches = finishedMatchPersistence.getPaginatedMatches(PAGE_SIZE, pageNumber);
            pageCount = (finishedMatchPersistence.getFinishedMatchCount() + PAGE_SIZE - 1) / PAGE_SIZE;
        } else {
            matches = finishedMatchPersistence.getPaginatedMatchesByPlayerName(PAGE_SIZE, pageNumber, playerName);
            pageCount = (finishedMatchPersistence.getFinishedMatchCountByPlayer(playerName) + PAGE_SIZE - 1) / PAGE_SIZE;
        }
